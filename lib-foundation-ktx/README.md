...
[![Maven Central](https://img.shields.io/maven-central/v/ir.farsroidx/andromeda-foundation-ktx.svg)](https://mvnrepository.com/artifact/ir.farsroidx/andromeda-foundation-ktx)
```toml
[versions]
