...
import andromeda.viewmodel.contract.AndromedaViewEvent as ViewEvent
import andromeda.viewmodel.contract.AndromedaViewState as ViewState
 ...
 * ) : AndromedaMvvmViewModel<HomeState, HomeEvent>() {
 *
 ...
 *
 * Notes:
 * - State updates are computed in [andromeda.viewmodel.dispatcher.AndromedaDispatcherProvider.default] and applied on main thread.
 * - Events are emitted safely from any thread using [andromeda.viewmodel.dispatcher.AndromedaDispatcherProvider.io].
