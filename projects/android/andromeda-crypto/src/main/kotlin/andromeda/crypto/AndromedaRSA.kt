...
object AndromedaRSA {
    ...
    fun getPublicKeyBase64(identifier: String? = null): String = AndromedaBase64.encode(value = getPublicKey(identifier).encoded)

    fun getPublicKeyPem(identifier: String? = null): String =
        buildString {
