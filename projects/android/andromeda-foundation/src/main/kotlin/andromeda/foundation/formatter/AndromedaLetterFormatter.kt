...
package andromeda.foundation.formatter

// @formatter:off // TODO: Do not remove this line to preserve the code style ----------------------

object AndromedaLetterFormatter {
    private val persianToEnglishNumerals =
        mapOf(
            '۰' to '0',
            '۱' to '1',
            '۲' to '2',
    ...
    private val arabicToEnglishNumerals =
        mapOf(
            '٠' to '0',
            '١' to '1',
            '٢' to '2',
    ...
    private val englishToPersianNumerals =
        mapOf(
            '0' to '۰',
            '1' to '۱',
            '2' to '۲',
    ...
    private val englishToArabicNumerals =
        mapOf(
            '0' to '٠',
            '1' to '١',
            '2' to '٢',
    ...
    private val arabicToPersianLetters =
        mapOf(
            'ك' to 'ک',
            'ي' to 'ی',
            'ة' to 'ه',
    ...
    private val persianToArabicLetters =
        mapOf(
            'ک' to 'ك',
            'ی' to 'ي',
            'ه' to 'ة',
    ...
    private val commonReplacements =
        mapOf(
            "ﻻ" to "لا",
            "ﻷ" to "لأ",
            "ﻹ" to "لإ",
    ...
    fun toPersianNumerals(value: String): String =
        value
            .map { char ->
                when (char) {
                    in englishToPersianNumerals -> {
                        englishToPersianNumerals[char]!!
                    }
    ...
    fun toArabicNumerals(value: String): String =
        value
            .map { char ->
                when (char) {
                    in englishToArabicNumerals -> {
                        englishToArabicNumerals[char]!!
                    }
