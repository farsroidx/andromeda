...
interface AndromedaLogger {
    ...
    fun v(value: Any?) = log(level = AndromedaLogLevel.VERBOSE, value = value)

    fun d(value: Any?) = log(level = AndromedaLogLevel.DEBUG, value = value)

    fun i(value: Any?) = log(level = AndromedaLogLevel.INFO, value = value)

    fun w(value: Any?) = log(level = AndromedaLogLevel.WARN, value = value)

    fun e(value: Any?) = log(level = AndromedaLogLevel.ERROR, value = value)

    fun e(throwable: Throwable) = log(level = AndromedaLogLevel.ERROR, throwable = throwable)
