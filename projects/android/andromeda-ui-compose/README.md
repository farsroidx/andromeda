...
📌 **Note**: By adding `andromeda-ui-compose`, you do not need to add `andromeda-ui-core` separately, as all its functionality is already included.
...
[![Maven Central](https://img.shields.io/maven-central/v/ir.farsroidx/andromeda-ui-compose.svg)](https://mvnrepository.com/artifact/ir.farsroidx/andromeda-ui-compose)
```toml
[versions]
