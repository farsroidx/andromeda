...
[![Maven Central](https://img.shields.io/maven-central/v/ir.farsroidx/andromeda-viewmodel.svg)](https://mvnrepository.com/artifact/ir.farsroidx/andromeda-viewmodel)
```toml
[versions]
